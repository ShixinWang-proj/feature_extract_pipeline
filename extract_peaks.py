...
def extract_peaks_and_valleys(input_parquet, output_parquet, fs=100):
    """从滤波后数据中提取波峰、波谷，执行 HRV 质控，保存结果"""
    ...
    print(f"🎉 任务完成！带有干净形态特征的数据已保存至: {output_parquet}")
    return True
...
if __name__ == "__main__":
    ...
    extract_peaks_and_valleys(input_path, out_path, fs=fs)
